...
ActiveRecord::Schema.define(version: 2020_02_14_151619) do
  ...
  create_table "gtid_executed", primary_key: ["source_uuid", "interval_start"], options: "/*!50100 TABLESPACE `mysql` */ ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci STATS_PERSISTENT=0 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
